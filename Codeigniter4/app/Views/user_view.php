...
<body>
   ...
   <div class="container mt-3">
      ...
      <a class="btn btn-primary" href="/user/tambahdata" role="button">Add</a>
         ...
         <tbody>
            <?php foreach ($user as $row) : ?>
               <tr>
                  ...
                  <td><?= $row['email']; ?></td>
                  <td>
                     <a class="btn btn-success" href="/user/edit/<?= $row['id']; ?>"  role="button">Edit</a>
                     <a class="btn btn-danger text-white" onclick="hapusData(<?= $row['id']; ?>)" role="button">Delete</a>
                  </td>
               </tr>
            <?php endforeach; ?>
         </tbody>
